...
Distributed systems can be difficult to design and even harder to implement. When
...
To aid in the identification of concurrency bugs and help build confidence in our services and to adhere
to formal specifications, we support a special form of monitoring designed to detect violations
of the system's properties. _Conformance monitoring_  uses formal modelling techniques to
